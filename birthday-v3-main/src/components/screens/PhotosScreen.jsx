...
export default function PhotosScreen({ onNext }) {
  ...
  return (
    <div className="relative px-4 md:px-6 py-10 overflow-hidden">
      <BackgroundHearts />
      ...
      <div className="relative z-10">
        <div className="text-center mb-6">
          ...
          >
            Cute-You<span className="text-white drop-shadow-[0_0_8px_rgba(255,100,150,0.8)] inline-block ml-1">🥰</span> 
          </motion.h2>
